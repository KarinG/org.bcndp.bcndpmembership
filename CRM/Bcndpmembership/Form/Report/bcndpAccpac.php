 ...
 *
 */
class CRM_Bcndpmembership_Form_Report_bcndpAccpac extends CRM_Report_Form {
    ...
    $this->_columns = array(
      ...
      'civicrm_financial_account' =>
        array('dao' => 'CRM_Financial_DAO_FinancialAccount',
          ...
          'group_bys' => array(
            'accounting_code' => array('title' => ts('Accounting Code')),
          ),
        ),
    ...
    $this->_from = "
        FROM civicrm_contact  {$this->_aliases['civicrm_contact']}
            ...
            LEFT  JOIN civicrm_financial_account {$this->_aliases['civicrm_financial_account']}
                     ON {$this->_aliases['civicrm_financial_account']}.name = {$this->_aliases['civicrm_financial_type']}.name
    ";
