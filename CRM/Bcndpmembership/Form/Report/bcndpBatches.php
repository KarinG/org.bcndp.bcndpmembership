 ...
 *
 */
class CRM_Bcndpmembership_Form_Report_bcndpBatches extends CRM_Report_Form {
          ...
          foreach ($table['group_bys'] as $fieldName => $field) {
            if (CRM_Utils_Array::value($fieldName, $this->_params['group_bys'])) {
              ...
              if (CRM_Utils_Array::value('frequency', $table['group_bys'][$fieldName]) &&
                ...
                // As of PHP7.1, can no longer assign an element to an array's sub dim that has not been declared. 
