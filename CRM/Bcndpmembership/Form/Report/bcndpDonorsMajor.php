 ...
 *
 */
class CRM_Bcndpmembership_Form_Report_bcndpDonorsMajor extends CRM_Report_Form {
...
//                'required' => TRUE,
      ...
      'civicrm_contribution' => array(
        ...
        'fields' => array(
          ...
          'amounts_ytd11' => array(
            'title' => ts('Amount - YTD 2011'),
            'required' => TRUE,
            'dbAlias' => "SUM(CASE WHEN year(contribution_civireport.receive_date)=2011 THEN contribution_civireport.total_amount ELSE 0 END)",
          ),
          'amounts_ytd12' => array(
            'title' => ts('Amount - YTD 2012'),
            'required' => TRUE,
            'dbAlias' => "SUM(CASE WHEN year(contribution_civireport.receive_date)=2012 THEN contribution_civireport.total_amount ELSE 0 END)",
          ),
          'amounts_ytd13' => array(
            'title' => ts('Amount - YTD 2013'),
            'required' => TRUE,
            'dbAlias' => "SUM(CASE WHEN year(contribution_civireport.receive_date)=2013 THEN contribution_civireport.total_amount ELSE 0 END)",
          ),
          'amounts_ytd14' => array(
            'title' => ts('Amount - YTD 2014'),
            'required' => TRUE,
            'dbAlias' => "SUM(CASE WHEN year(contribution_civireport.receive_date)=2014 THEN contribution_civireport.total_amount ELSE 0 END)",
          ),
          'amounts_ytd15' => array(
          ...
          'financial_type_ids' =>
            array(
              'title' => 'Financial Type IDs',
              'default' => TRUE,
              'dbAlias' => "GROUP_CONCAT(contribution_civireport.financial_type_id ORDER BY contribution_civireport.financial_type_id SEPARATOR ', ')",
            ),
        ),
        'filters' => array(
            'receive_date' =>
      ...
      'civicrm_contribution_recur' => array(
        ...
        //    'required' => FALSE,
            'title' => ts("Series ID"),
            'dbAlias' => "contribution_recur_civireport.id",
          ),
          'start_date' => array(
       //     'required' => TRUE,
